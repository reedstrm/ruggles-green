...
public class JdoResourceEntity {
     ...
     * of this entity type.
     * The externally exposed resource id is derived from this key.
     */
    @PrimaryKey
    ...
    /**
     * The blob key of this resource. Exists in states where hasBlobKey() is true,
     * null otherwise.
     */
    @Persistent
    ...
    /**
     * Get the id of this resource. The id is unique only mong resource entities.
     * 
    ...
    public void  pendingToUploadedTransition(BlobKey newBlobKey) {
        Assertions.check(state == State.PENDING_UPLOAD, "Encountered %s", state);
    ...
    /**
     * Convert a resource entity id to externally visible string encoded id. This is
     * the inverse operation of stringToResouceId();
     * 
    ...
    /**
     * Convert a resource entity id to externally visible resource id. The is the
     * inverse operation of resourceIdToString();
     * 
