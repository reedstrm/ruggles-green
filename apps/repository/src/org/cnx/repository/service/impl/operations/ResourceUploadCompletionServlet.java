...
public class ResourceUploadCompletionServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        // should be deleted.
        //
        // NOTE(tal): since blob deletion and data store entity update cannot be done in
        ...
        try {
            ...
            checkState(blobKey.equals(blobInfo.getBlobKey()), "Blob key mismatch");
            ...
            ormEntity.pendingToUploadedTransition(new OrmBlobInfo(blobInfo, contentTypeToUse));
